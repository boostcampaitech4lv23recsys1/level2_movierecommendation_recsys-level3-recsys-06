...
이번 Movie Recommendation 프로젝트는 사용자의 영화 시청 이력 데이터를 바탕으로 사용자가 다음에 시청할 영화 및 좋아할 영화를 예측하는 과제입니다.

![image]<img width="852" alt="movie" src="https://user-images.githubusercontent.com/82706646/213186991-b4ca80a9-9089-4eb6-8a94-1296ffaecb7b.png">
